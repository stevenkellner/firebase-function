...
describe('Sha512', () => {
    ...
    it('hex encoding uppercased', () => {
        const hasher = new Sha512({ hexWithUppercase: true });
        expect(hasher.hash('')).to.be.equal('CF83E1357EEFB8BDF1542850D66D8007D620E4050B5715DC83F4A921D36CE9CE47D0D13C5D85F2B0FF8318D2877EEC2F63B931BD47417A81A538327AF927DA3E');
        expect(hasher.hash('ksadhlömasc298089qwer')).to.be.equal('043DB36E403E5B6C13AD8CA0EE3A1D5C81D51F5EE89879A9011A39B69281DEABB531F17ADF792D92204B6E9041F91124FE8006CAB41457A93886BB7649F12ACF');
        expect(hasher.hash('', 'Acgva')).to.be.equal('A5C76FA37DC4FD98932E34D7248B55944BE8FE9101C16032F7BC66938DC98F6547288B8960ECC209061108C7A3922AB85FE4AF1F2A1AAC66E14D1239FF9D8AF1');
        expect(hasher.hash('ksadhlömasc298089qwer', 'Acgva')).to.be.equal('C3AEAED2EE38F57CD635DE3905AA7C7607A4505C2F6BB8A63CF21BBFBA4111BAA7203BA4CB3F6618040356EFD9209D233B1B0D980FDB1A6D50EB91425D5D6746');
    ...
    it('base64 encoding with padding', () => {
        const hasher = new Sha512({ base64WithPadding: '=' });
        expect(hasher.hash('')).to.be.equal('z4PhNX7vuL3xVChQ1m2AB9Yg5AULVxXcg/SpIdNs6c5H0NE8XYXysP+DGNKHfuwvY7kxvUdBeoGlODJ6+SfaPg==');
        expect(hasher.hash('ksadhlömasc298089qwer')).to.be.equal('BD2zbkA+W2wTrYyg7jodXIHVH17omHmpARo5tpKB3qu1MfF633ktkiBLbpBB+REk/oAGyrQUV6k4hrt2SfEqzw==');
        expect(hasher.hash('', 'Acgva')).to.be.equal('pcdvo33E/ZiTLjTXJItVlEvo/pEBwWAy97xmk43Jj2VHKIuJYOzCCQYRCMejkiq4X+SvHyoarGbhTRI5/52K8Q==');
        expect(hasher.hash('ksadhlömasc298089qwer', 'Acgva')).to.be.equal('w66u0u449XzWNd45Bap8dgekUFwva7imPPIbv7pBEbqnIDukyz9mGAQDVu/ZIJ0jOxsNmA/bGm1Q65FCXV1nRg==');
    ...
    it('custom alphabet', () => {
        const hasher = new Sha512({ alphabet: 'ABCDEFGH' });
